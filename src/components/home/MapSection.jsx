  ...
  return (
    <section ref={sectionRef} className="relative h-[500px] w-full bg-gray-200">
      ...
      {isVisible && (
        ...
        >
          {!isInteractive && (
            <div className="absolute inset-0 z-20 cursor-pointer bg-transparent" title="اضغط للتفاعل مع الخريطة"></div>
          )}
          <iframe
            ...
            className={`w-full h-full border-0 ${!isInteractive ? 'pointer-events-none' : ''}`}
            allowFullScreen=""
            loading="lazy"
