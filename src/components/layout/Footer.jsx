...
const Footer = () => {
  return (
    <footer className="bg-light pt-16 pb-8 border-t border-blue/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-6">
              {/* Location */}
              <div className="flex items-center gap-4 text-blue/60 group">
                <div className="w-10 h-10 rounded-xl bg-gold/5 flex items-center justify-center text-gold transition-colors group-hover:bg-gold group-hover:text-white">
