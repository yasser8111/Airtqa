...
const NewsCard = ({ item, index }) => {
  ...
  return (
    <div className={`reveal reveal-delay-${(index % 3) + 1}`}>
      <article
        className="bg-white rounded-2xl overflow-hidden border-2 border-gray-100 shadow-blue/10 hover:shadow-xl transition-all duration-300 group flex flex-col hover:-translate-y-2 hover:scale-[1.02]"
      >
        {/* Image Container */}
